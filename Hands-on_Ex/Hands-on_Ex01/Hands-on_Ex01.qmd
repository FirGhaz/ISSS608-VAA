...
![](images/ggplot2.png){width="99%"} It is also part of the tidyverse family specially designed for visual exploration and communication.

![](images/ggplot2b.png){width="99%"} For more detail, visit [*ggplot2*](https://ggplot2.tidyverse.org/) link.
...
![](images/Layered.jpg){width="98%"} A short description of each building block are as follows:
