...
![](images/200123867-db9bd406-54d7-4ce0-aa09-1ec30740a87a.jpg)

# ![](images/clipboard-3334102897.gif){style="gray" width="35"} 2.1 Overview

In this exercise, the learning outcomes will be in threefolds:
...
## 2.2.1 Installing and loading the requirement libraries

| *R Packages* | *What does the package provide?*                                     |
|--------------|----------------------------------------------------------------------|
...
**ggrepel** is an extension of **ggplot2** package which provides `geoms` for **ggplot2** to repel overlapping text as in our examples on the right. We simply replace `geom_text()` by  [`geom_text_repel()`](#0) and `geom_label()` by [`geom_label_repel`](#0).

## ![](images/clipboard-3896436334.png){width="42"}2.3.1 Working with ggrepel
...
### ![](https://r4va.netlify.app/chap02/img/image4.png){width="40" height="50"}2.5.1 **Creating Composite Graphics: pathwork methods**
...
## 2.5.4 Creating a cocompositeigure with tag
