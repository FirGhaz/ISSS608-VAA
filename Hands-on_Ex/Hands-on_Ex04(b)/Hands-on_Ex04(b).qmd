...
In the code chunk below, [**read_xls()**](https://readxl.tidyverse.org/reference/read_excel.html) of readxl package is used to import the data worksheet of ToyotaCorolla.xls workbook into R.
