...
## 5.3.1 Preparing and Transforming Data frame into matrix
...
In this section, you will learn how to plot static heatmaps by using 8heatmap()* of R Stats package.
...
Note: 
  ...
  - By default, `heatmap()` plots a cluster heatmap. The arguments _Rowv=NA_ and _Colv=NA_ are used to switch off the option of plotting the row and column dendrograms.
