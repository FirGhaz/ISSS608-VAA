...
# 7.4 Chloropleth Mapping Geospatial Data using `tmap`
...
## 7.4.1 Plotting a chloropeth map quickly by using `qtm()`
...
## 7.4.2 Creating a chloropleth map by using `tmap`'s elements
...
## 7.4.6 Drawing Small Multiple Chloropleth Maps
