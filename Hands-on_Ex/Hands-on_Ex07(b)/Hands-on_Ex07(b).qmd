...
subtitle: "Hands-On Exercise 7(b)"
author: "FirGhaz"
date: 23/02/2024
...
The figure below shows the first 15 records of SGPools_svy21.csv. It consists of seven columns. The XCOORD and YCOORD columns are the x-coordinates and y-coordinates of SingPools outlets and branches. They are in [Singapore SVY21 Projected Coordinates System](https://www.sla.gov.sg/sirent/CoordinateSystems.aspx).

![](images/image1.jpg)

## **7.2 Data Import and Preparation**
...
## **7.3 Creating a sf data frame from an aspatial data frame**
...
# **7.4 Drawing Proportional Symbol Map**
...
## **7.4.1 It all started with an interactive point symbol map**
...
## **7.4.2 Lets make it proportional**
...
## **7.4.3 Lets give it a different colour**
