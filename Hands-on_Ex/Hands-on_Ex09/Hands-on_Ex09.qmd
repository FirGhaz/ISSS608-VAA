---
title: "9 Information Dashboard Design: R methods"
subtitle: "Hands on Exercise 09"
author: "FirGhaz"
date: 28/03/2024
...
# **9  Information Dashboard Design: R methods**
...
### **9.3.2 Importing database into R**
...
Note: Before running the code chunk, you need to change the R system to a 32-bit version. This is because the odbcConnectAccess() is based on 32-bit and not 64-bit.
...
### **9.6.1 Plotting Coffechain Sales report**
...
Instead of displaying the values as sparkline, we can display them as sparkbars as shown below.
