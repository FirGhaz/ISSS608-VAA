...
By default, read_csv will import data in Date field as Character data type. dmy() of [*lubridate*](https://lubridate.tidyverse.org/) package to palse the Date field into appropriate Date data type in R.
:::
